...
const CATEGORY_STYLES = {
  medicine: { label: 'Medicine', badge: 'bg-purple-50 text-purple-600' },
  appointment: { label: 'Appointment', badge: 'bg-blue-50 text-blue-600' },
  mundane: { label: 'Mundane', badge: 'bg-emerald-50 text-emerald-600' },
}
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-5">
          <div className="lg:col-span-1 space-y-4">
            ...
            <div className="bg-white rounded-2xl border border-gray-100 shadow-sm p-4">
              <p className="text-xs font-semibold text-gray-500 mb-3 uppercase tracking-wider">Sync Status</p>
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <p className="text-xs text-gray-400">
                    {googleError ? 'Google not connected yet' : 'Connected and syncing'}
                  </p>
                </div>
              </div>
              {googleError && (
                ...
                <div className="flex flex-col gap-3">
                  {dayEvents.map((event) => (
                    <div
                      ...
                      className="flex items-start gap-4 p-4 rounded-2xl border border-gray-100 shadow-sm"
                    >
